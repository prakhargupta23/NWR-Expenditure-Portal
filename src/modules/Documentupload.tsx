...
const documentTypes = [
  { key: "PurchaseOrder", label: "Purchase Order(PO)", icon: "Issued by StoresOfficer authorising procurement of specified items at agreed terms." },
  { key: "InspectionCertificate", label: "Inspection Note", icon: "Issued by Inspecting agency nominated in the PO, certifying quality before dispatch." },
  { key: "TaxInvoice", label: "Tax Invoice", icon: "Raised by the vendor for the supplied materials as per GST and contractual terms." },
  { key: "ReceiptNote", label: "Receipt Note", icon: "Generated by the consignee confirming receipt and acceptance of material" },
  { key: "ModificationAdvice", label: "Modification Advice", icon: "Issued by competent authority to record approved changes in PO terms, quntity, rate etc." },
  { key: "GSTInvoice", label: "Bill", icon: "Prepared by the Accounts for processing payment to the vendor." },
                        ...
                        return (
                          <React.Fragment key={docType.key}>
                            <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', minWidth: '320px', py: 1 }}>
                              {/* Label left aligned */}
                              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'left', width: '40%', minWidth: '320px', py: 0.5 }}>
                                <Typography sx={{ flex: 2, textAlign: 'left', fontWeight: 500, fontSize: '1rem', color: '#fff', pl: 1, letterSpacing: '0.05em' }}>
                                  {docType.label}
                                </Typography>
                                <Typography sx={{ flex: 2, textAlign: 'left', fontWeight: 300, fontSize: '0.7rem', color: '#949494', pl: 1, letterSpacing: '0.05em' }}>
                                  {docType.icon}
                                </Typography>
                              </Box>
